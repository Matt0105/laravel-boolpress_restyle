...
@section('content')
{{-- @dd($userPosts->first()->category->name) --}}
<h2 class="section-title">All Posts by user '<span class="highlight">{{$userPosts->first()->user->name}}</span>'</h2>
    ...
    <li class="posts-item">
        <div class="post-info-container">
            ...
            <div class="post-element-container category">
                <span class="post-element">{{$userPosts->first()->category->name}}</span>
            </div>
            <div class="post-element-container">
